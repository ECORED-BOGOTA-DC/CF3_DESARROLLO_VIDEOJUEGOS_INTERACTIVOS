  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 La animación en los videojuegos
        p.mb-4 Reconocer los elementos necesarios para editar y recrear la atmosfera de los videojuegos, generando con esto recursos gráficos atractivos y que aportan al desarrollo de aprendizajes.
