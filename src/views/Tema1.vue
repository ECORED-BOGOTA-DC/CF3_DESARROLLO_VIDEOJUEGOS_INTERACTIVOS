...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal.color-acento-contenido(data-aos="flip-up")
      ...
      h1
        i Rigging
    p.mb-4(data-aos="fade-right") Es el proceso por el cual se puede dar deformación a una malla para poder trabajarla en animación, creando un sistema de huesos el cual finalmente es el que se usará para dar vida a los objetos.
    .row.justify-content-center.align-items-center.BGblue.mb-4
      .col-5.col-lg-3.mb-4.mb-lg-0.position-relative(data-aos="fade-right")
        figure
          img(src="@/assets/curso/tema1/img01.svg", alt="Rigging")
      .col-lg-9.position-relative.p-3(data-aos="fade-left")
    ...
    p.mb-4(data-aos="fade-right") El #[i rigging] es el proceso mediante el cual se crean estructuras de esqueletos y estructuras de control con el fin de animar y deformar geometrías.
    p.mb-5(data-aos="fade-right") Podría decirse que el #[i rigging] está compuesto por un componente técnico y otro artístico: técnico por el desarrollo de código y la construcción de estructuras complejas; y artístico por la búsqueda de deformaciones que luzcan agradables (#[i appeal]) y al mismo tiempo sean creíbles.
    ...
    .tarjeta.tarjeta--azul.p-4.mb-5(data-aos="fade-right")
      SlyderA
        .row.justify-content-center
          .col-md-10
            p.mb-4 Cursor 3D y puntos de pivote: el cursor 3D es una herramienta muy útil dentro del #[i software] Blender, dado que da un punto de referencia desde el cual transformar los objetos; también sirve para alinear unos objetos con otros. El manejo correcto de este ayudará a establecer de manera adecuada los puntos de pivote de los objetos.
        ...
        .row.justify-content-center
          .col-md-10
            p.mb-4 Sistema de coordenadas: dentro de cualquier #[i software] 3D se disponen diferentes sistemas de coordenadas que ayudarán a transformar los objetos según las necesidades que se tengan. Sistemas de coordenadas como Globales, Locales, Gimbal, entre otros, son los que se explican a continuación:
            .video
    ...
    .BG03.p-4.mb-5(data-aos="fade-down")
    ...
    .BG03.p-4.mb-4(data-aos="fade-down")
      p.text-center.mb-0 En los siguientes videos se explica cómo se realiza el proceso de #[i skinning] al personaje que se viene trabajando:
    #MapaGroup01(data-aos="fade-left")
      .row.gx-4.mb-4
    ...
    .row.justify-content-center.mb-5
      ...
      .d-none.d-lg-block(data-aos="fade-left")
        figure
          img(src="@/assets/curso/tema1/img06.svg", alt="Curvas de control")
      .d-block.d-lg-none(data-aos="fade-left")
        figure
    ...
    .row.justify-content-center.mb-4(data-aos="fade-right")
      ...
      .col-8.mb-4
        a.anexo(:href="obtenerLink('downloads/CF003_1.4_Orient_custom_shape.zip')" target="_blank")
          ...
          .anexo__texto
            p Anexo. CF003_1.4_Orient_ custom_shape.zip
      .col-8
    ...
    .row.justify-content-center.align-items-end.BG03.mb-4
      .col-11.col-lg-8.mb-4.mb-lg-0.p-4(data-aos="fade-right")
      ...
      .col-5.col-lg-3(data-aos="fade-left")
        figure
          img(src="@/assets/curso/tema1/img07.svg", alt="Personaje base")
    p.mb-4(data-aos="fade-right") Cada uno de los gestos faciales debe modelarse o esculpirse, lo cual demanda paciencia y una continua búsqueda del appeal en el personaje. Puede surgir la pregunta ¿qué gestos o expresiones son las que deben modelarse? Pues existe una variedad infinita. Se debe categorizar en dos grupos: expresiones y visemas.
    p.mb-5(data-aos="fade-right") Las expresiones principales que se deben trabajar son: alegría, tristeza, enojo, sorpresa, disgusto y temor.
    ...
    .row.justify-content-center.mb-4
      .col-6.col-lg-3.mb-4.mb-lg-0(data-aos="fade-right")
        figure
          img(src="@/assets/curso/tema1/img10.jpg", alt="Ajustes finales y scripting")
      .col-lg-9(data-aos="fade-left")
        .row.justify-content-center.mb-4
          .col-10.bordLineLR.px-4
            p.mb-0 El proceso de #[em scripting] se puede definir como el desarrollo de una serie de líneas de código que son ejecutadas dentro de un #[i software] que pueden automatizar o extender las funciones de ciertos componentes.
        ...
        p.mb-4 En los videos siguientes se muestran los últimos detalles que se deben ajustar al #[em rig] para finalizar el proceso y organizar ciertas capas para construir un Panel de selección o Interfaz de Usuario (UI - User Interface) para un #[em rig], lo cual facilitará el trabajo del equipo de animación.
        .row.justify-content-center.mb-4
          .col-10
            a.anexo(:href="obtenerLink('downloads/CF003_1.6_script_ui.py')" target="_blank")
              .anexo__icono
                img(src="@/assets/template/icono-link.svg")
              .anexo__texto
                p Enlace. Descargar el archivo de #[i script] de tipo Python, el cual sirve de base para el diseño del panel.
    #MapaGroup03(data-aos="fade-down")
      .row.justify-content-center.gx-4.mb-4
        .col-6.col-lg-3.mb-2.mb-lg-0
    ...
    p.mb-4(data-aos="fade-right") Blender facilita la tarea a la hora de hacer el #[em rig] a partir del uso de #[em addons] propios del programa, para poder utilizarlos en la malla. Para ello, se tendrán que activar los #[em addons], de la siguiente manera:
    .row.justify-content-center.mb-3(data-aos="fade-left")
      .col-lg-10.mb-4
        SlyderC(:datos="datosSlyder")
      .col-lg-8.BG02.p-4.mb-5
        p.text-center.mb-0 Ahora se verá cómo se hace el Rigify a través del siguiente video tutorial.
      .col-lg-10.mb-4
        .video
      ...
      .col-lg-8
        p.mb-4 Para profundizar en el uso del #[em rigg] con Rigify, visitar el siguiente enlace:
    ...
    separador
    #t1_8.titulo-segundo.color-acento-contenido
      h2 1.8 #[em Autorig] con Mixamo
    p.mb-5(data-aos="fade-right") Para #[em "autoriggear"] a un personaje se tiene la opción de hacerlo mediante Mixamo de Adobe. A continuación podrá ver el paso a paso para utilizar Mixamo.
    ...
    separador
    #t1_9.titulo-segundo.color-acento-contenido
      h2 1.9 #[em Skinning] y pesos
    p.mb-5(data-aos="fade-right") En algunos casos se podrá notar que la malla, a pesar de que se está deformando para generar movimiento, puede que no se deforme correctamente.
    .row.justify-content-center.mb-4
