...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-10.mb-4 
        .cajon.color-acento-contenido.BG03.p-4.mb-4(data-aos="fade-right")
    ...
    SlyderA.mb-5(data-aos="fade-left")
      .row.justify-content-center
        .col-md-11
          .titulo-sexto.color-acento-contenido
            p.mb-0 #[b Figura 38]
            p.mb-0 #[i Archivo exportar]
          figure.mb-4
      ...
      .row.justify-content-center
        .col-md-11
          .titulo-sexto.color-acento-contenido
            p.mb-0 #[b Figura 46]
            p.mb-0 #[em Import FBX]
          figure.mb-4
            img(src='@/assets/curso/tema4/img09.jpg', alt='Import Fbx')
          p Para finalizar, se vuelve a exportar el #[i FBX] a Unity y ya se habrá corregido la lectura de la malla.
