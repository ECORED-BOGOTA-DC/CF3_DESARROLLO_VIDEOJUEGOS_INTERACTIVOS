...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-4(data-aos="fade-right") No es fácil determinar una fecha exacta, sin embargo, desde sus inicios, el ser humano ha tenido la necesidad de plasmar o representar las cosas que ve en el mundo que lo rodea. Ahora, se verá cómo se ha desarrollado la animación a través de la historia.
    .tarjeta.tarjeta--gris.p-4.mb-4(data-aos="fade-left")
      LineaTiempoC.color-acento-contenido
        ...
        .row(titulo="1906")
          ...
          .col-lg-8
            p.mb-4 Blackton y Edison hicieron pública la primera película animada #[i Humorous Phases of Funny Faces], usando la técnica de #[em stop motion] para crear movimiento. (Williams, 2009).
            .row.justify-content-center.mb-4
              .col-10
                a.anexo(href="https://www.youtube.com/watch?v=wGh6maN4l2I" target="_blank")
                  ...
                  .anexo__texto
                    p Video: #[i Humorous Phases of Funny Faces.]
        .row(titulo="1908")
          .col-lg-4.mb-4.mb-lg-0
            figure.mb-4
              img(src="@/assets/curso/tema2/img14.jpg", alt="historia imagén 13")
          .col-lg-8
            p.mb-4 El caricaturista parisino Émile Cohl lanza la que es considerada la primera película totalmente animada que se titula #[i Fantasmagorie].
            .row.justify-content-center.mb-4
              .col-10
        ...
        .row(titulo="1910")
          ...
          .col-lg-8
            p.mb-0 Ladislaw Starevwicz, animador ruso, crea #[i La bella Lukanida (Piekna Lukanida)] la primera animación con marionetas utilizando la técnica de #[em stop motion].
        .row(titulo="1911")
          .col-lg-4.mb-4.mb-lg-0
            figure.mb-4
              img(src="@/assets/curso/tema2/img16.jpg", alt="historia imagén 17")
          .col-lg-8
            p.mb-4 Winsor McCay, exitoso dibujante de tiras cómicas, basado en una de sus tiras más conocidas #[i Little Nemo in Slumberland (El pequeño Nemo en el país de los sueños)] hace animaciones para películas.
            .row.justify-content-center.mb-4
              .col-10
        ...
        .row(titulo="1914")
          ...
          .col-lg-8
            p.mb-4 Nuevamente, Winsor crea #[i Gertie el dinosaurio] mediante la técnica de los fotogramas clave hace la primera película animada donde el protagonista tiene una personalidad reconocible.
            .row.justify-content-center.mb-4
              .col-10
        ...
        .row(titulo="1916")
          ...
          .col-lg-8
            h3 Rotoscopo
            p.mb-0 Max Fleischer consigue la patente del rotoscopio y siguiendo la referencia de filmaciones de su hermano crea la película #[i Out of the inkwell].
        .row(titulo="1918")
          .col-lg-4.mb-4.mb-lg-0
            figure.mb-4
              img(src="@/assets/curso/tema2/img19.jpg", alt="historia imagén 18")
          .col-lg-8
            p.mb-4 Se crea #[i The sinking of the Lusitania], un hito de la animación para el cine de propaganda por parte de Winsor McCay.
            .row.justify-content-center.mb-4
              .col-10
                a.anexo(href="https://en.wikipedia.org/wiki/File:Winsor_McCay_(1918)_The_Sinking_of_the_Lusitania.webm" target="_blank")
                  .anexo__icono
                    img(src="@/assets/template/icono-link.svg")
                  .anexo__texto
                    p Video: #[i The sinking of the Lusitania].
        .row(titulo="1919 - 1921")
          h3.mb-1 1919
          p.mb-4 Paramount Pictures estrena el cortometraje animado #[i Feline Follies].
          h3.mb-1 1920
          p.mb-4 #[i The Debut of Thomas Cat] se estrena y es famosa por ser la primera obra de dibujos animados en color.
          h3.mb-1 1921
        ...
        .row(titulo="1923")
          ...
          .col-lg-8
            p.mb-4 Disney mezcla dibujos animados y acción real en #[i Alice's Wonderland (Alicia en el país de las maravillas)].
            .row.justify-content-center.mb-4
              .col-10
        ...
        .row(titulo="1930")
          ...
          .col-lg-8
            h3 Betty Boop
            p.mb-4 Aparece por primera vez en #[i Dizzy Dishes] la icónica Betty Boop de Fleischer Studios. Mientras tanto en Francia se estrena el primer largometraje de marionetas animadas, #[i Le roman] de Renard de Starevwicz.
        .row(titulo="1932 - 1935")
          h3.mb-1 1932
          p.mb-4 Surge el Technicolor en la animación de la mano del cortometraje #[i Flowers and Trees] de Disney.
          h3.mb-1 1933
          p.mb-4 Mediante el uso de #[em stop motion] Willis O’Brien crea su gorila para #[i King Kong], también se estrena #[i Los tres cerditos] de Disney, la primera película del estudio que sugiere una personalidad animada.
          h3.mb-1 1934
          p.mb-4 Es presentado al público el Pato Donald en la película #[i The Wise Little Hen].
          h3.mb-1 1935
          p.mb-0 German Oskar Fischinger realiza la animación abstracta #[i Komposition in Blau].
        .row(titulo="1937")
          .col-lg-4.mb-4.mb-lg-0
            figure.mb-4
          ...
          .col-lg-8
            h3 Snow White
            p.mb-4 Es estrenada una de las películas más icónicas de Disney, #[i Blancanieves] y los siete enanos que es el primer largometraje animado en Technicolor con uso de sonido sincronizado.
        .row(titulo="1939 - 1942")
          h3.mb-1 1939
          p.mb-4 Fleischer Studios crea #[i Los viajes de Gulliver] desafiando el monopolio de Disney en el género animado.
          h3.mb-1 1940
          p.mb-4 Disney estrena #[i Pinocho] y #[i Fantasía] que sorprendentemente reciben una pobre acogida por parte del público. En el mismo año William Hanna y Joseph Barbera crean y estrenan el primer animado de #[i Tom y Jerry].
          h3.mb-1 1941
        ...
        .row(titulo="1944 - 1949")
          ...
          h3.mb-1 1947
          p.mb-4 Tintín debuta en la animación con una versión en marionetas de #[i El cangrejo de las pinzas de oro].
          h3.mb-1 1948
          ...
          h3.mb-1 1949
          p.mb-0 #[i El coyote y el correcaminos] de Chuck Jones aparecen por primera vez en el cortometraje #[i Fast and Furry-ous].
        .row(titulo="1950")
          .col-lg-4.mb-4.mb-lg-0
            figure.mb-4
          ...
          .col-lg-8
            h3 #[i La cenicienta]
            p.mb-4 Es estrenada #[i Cinderella (La cenicienta)] de Disney; y es estrenado el primer dibujo animado creado para televisión en Estados Unidos.
        .row(titulo="1952 - 1957")
          h3.mb-1 1952
          p.mb-4 Es introducida la técnica de la pixilación por parte de Norman McLaren en la película #[i Neighbours].
          h3.mb-1 1953
          p.mb-4 Es creado #[i Duck Amuch (el pato Lucas)] en EE. UU. por Chuck Jones, animador de la Warner Bros.
          h3.mb-1 1954
          p.mb-4 A partir de #[i Animal Farm] la célebre novela de George Orwell, se anima la película del mismo nombre por parte de los animadores John Halas y Joy Batchelor.
          h3.mb-1 1957
          p.mb-0 Hace su más famosa aparición Bugs Bunny en el cortometraje de #[i Jones What’s opera, doc?]
        .row(titulo="1958 - 1961")
          h3.mb-1 1958
          p.mb-4 Se estrena el primer largometraje animado japonés titulado #[i Shonen Saturobi Sasuke (La leyenda de la serpiente blanca)], mientras #[i La bella durmiente] resulta ser un desastre comercial para Disney.
          h3.mb-1 1960
          p.mb-4 Fred Flinstone y Barney Rubble (Pedro Picapiedra y Pablo Marmol) son presentados en la serie animada #[i The Flinstones] por William Hanna y Joseph Barbera.
          h3.mb-1 1961
        ...
        .row(titulo="1963 - 1965")
          ...
          h3.mb-1 1964
          p.mb-4 Se crea la película experimental #[i Cibernetik 5.3] por John Stehura.
          h3.mb-1 1965
          p.mb-4 Se crea la película animada de marionetas #[i Ruka (La mano)] del checo Jiri Trinka como una forma de protesta contra la represión de los regímenes totalitarios.
        .row(titulo="1966 - 1972")
          h3.mb-1 1966
          p.mb-4 Muere Walt Disney a la edad de 65 años sin ver finalizado #[i Disneyworld]. En la televisión británica aparece #[i Camberwick Green].
          h3.mb-1 1969
          p.mb-4 Se emite en Japón el primer episodio de la serie #[i Sazae-san] que sigue emitiéndose en la actualidad convirtiéndose en la serie de animación más longeva.
          p.mn-0 En Inglaterra se emite #[i The Clangers] de Oliver Postgate y Peter Firmin.
          h3.mb-1 1972
          p.mb-4 Se funda Atari.
        .row(titulo="1974 - 1977")
          h3.mb-1 1974
          p.mb-4 Es creada la serie #[i Heidi] de la mano de Hayao Miyasaki e Isao Takahata.
          h3.mb-1 1975
        ...
        .row(titulo="1982 - 1986")
          ...
          h3.mb-1 1986
          p.mb-4 #[i Luxo Jr] dirigido por John Lasseter se convierte en una importante referencia para la animación digital.
          p.mn-0 Es fundada Pixar.
        .row(titulo="1988 - 1991")
          h3.mb-1 1988
          p.mb-4 El largometraje #[i ¿Quién engañó a Roger Rabbit?] es estrenado haciendo un hibrido entre animación e imagen real.
          ...
          p.mn-4 Son lanzados #[i Los Simpsons] de Matt Groening.
          h3.mb-1 1991
        ...
        .row(titulo="1998")
          ...
          .col-lg-8
            h3 #[i A Bug’s Life]
            p.mb-4 Es estrenada #[i A Bug’s Life] de pixar y #[i Antz] de Dreamworks.
        .row(titulo="1999 - 2001")
          ...
          h3.mb-1 2001
          p.mb-4 Se estrena #[i El viaje de Chihiro] de Hayao Miyasaki.
        .row(titulo="2002 - 2006")
          h3.mb-1 2002
          p.mb-4 Es utilizada con éxito la técnica de captura de movimiento para dar vida a Gollum en #[i The Lord of the Rings: The Two Towers].
          p.mb-4 Blue Sky Animation Studios estrena #[i Ice Age].
          h3.mb-1 2004
          p.mb-4 Es estrenada #[i The Incredibles] de Pixar dirigida por Brad Bird.
          h3.mb-1 2005
          p.mb-4 Se estrena #[i Corpse Bride] dirigida por Tim Burton y #[i Wallace y Gromit: The Curse of the Were-Rabbit] de Steve Box renovando el interés por la animación en #[em stop motion].
          h3.mb-1 2006
        ...
        .row(titulo="2008 - 2016")
          ...
          .col-lg-8
            ...
            h3 2016 - Creadores de #[i Historia de un oso]
            p.mb-0 #[i Historia de un oso], cortometraje de animación chileno se convierte en la primera producción latinoamericana en ganar un Óscar.
    separador
    #t2_2.titulo-segundo.color-acento-contenido
      h2 2.2 Técnicas de animación
    p.mb-4(data-aos="fade-right") Existen varios estilos o técnicas de animación que van desde el uso de la fotografía y dibujo a mano hasta las imágenes generadas por computadora. En este apartado no se pretende profundizar en cada una de las técnicas, pues la información y proceso de producción de cada una es muy extensa; más bien, se busca caracterizar de forma general cada una de las técnicas y ahondar en aquellas que sean de interés.
    .tarjeta.tarjeta--azul.p-5.p-lg-4.mb-5(data-aos="fade-left")
      SlyderA
    ...
    .row.justify-content-center
      .col-lg-10
        ...
        .video.mb-4(data-aos="fade-right")
        ...
        p.mb-4(data-aos="fade-down") En esta animación se observa en el #[em frame] 1 que el pie derecho (rojo) está pisando sobre su talón, y el pie izquierdo (azul) está en punta y los brazos se encuentran en sentido opuesto a su color correspondiente. Es decir, el brazo izquierdo se mueve en sentido contrario de la pierna izquierda.
        .BG02.p-4.mb-4(data-aos="fade-left")
        ...
        h3.text-center.Color3.bordLineT.pt-5(data-aos="fade-right") #[em Attack]
        .row.justify-content-center(data-aos="fade-left")
          .col-lg-10.mb-4
        ...
        h3.text-center.Color3.bordLineT.pt-5(data-aos="fade-right") #[em Down]
        ...
        h3.text-center.Color3.bordLineT.pt-5(data-aos="fade-right") #[em Dead]
        .row.justify-content-center(data-aos="fade-left")
          .col-lg-10.mb-4
