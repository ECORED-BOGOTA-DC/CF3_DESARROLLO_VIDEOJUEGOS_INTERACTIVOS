...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5
      ...
      .col-md-6.col-lg.tarjeta--tabla.p-4(data-aos="fade-down")
        .row.justify-content-center.mb-3
          .col-4
    ...
    .row.justify-content-center
      .col-lg-10
        ...
        p.mb-4.text-center(data-aos="fade-left") Audacity es un programa de edición de audio, totalmente gratuito. Aquí se podrá ver un tutorial básico de cómo utilizarlo.
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        ...
        .tarjeta-avatar-b.mb-4(data-aos="fade-left")
        ...
        .bordLineLR.p-4(data-aos="fade-left")
    ...
    SlyderA(data-aos="fade-down")
      ...
      .row.justify-content-center
        .col-md-11
          .row.justify-content-center
            .col-lg-5.mb-4.mb-md-0
              p En esta imagen se presenta a un grupo de soldados luchando contra el enemigo en un día soleado. De acuerdo a esto, se podría decir que se puede escuchar el sonido tanto de nuestras balas como las de los enemigos, diferentes voces, gritos o diálogos de nuestros compañeros o enemigos, efectos de artillería pesada, explosiones, fuego, sonidos de pisadas, recarga de armas; creando un ambiente conflictivo que logra transmitirnos esa tensión, gracias a una paleta de sonidos más rica y variada que aporta mayor realismo a la escena.          
            .col-lg-7
              .titulo-sexto.color-acento-contenido
                p.mb-0 #[b Figura 35]
    ...
    p.mb-5(data-aos="fade-right") Los formatos de sonido son decodificadores que transmiten la señal junto al video, los más usados por la industria de los videojuegos son:
    .row.justify-content-center.mb-5.p-4.BG02
      .col-lg-6.bordLineRr.p-4(data-aos="fade-right")
        figure.mb-4
